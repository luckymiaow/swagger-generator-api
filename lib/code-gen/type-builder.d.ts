...
export declare function buildType(obj: OpenAPI3SchemaObject | OpenAPI3Reference, types: DotNetTypes, schemas?: OpenAPI3Schemas): IDotnetType;
export declare function findOrBuildType(typeRef: string, obj: OpenAPI3SchemaObject | OpenAPI3Reference, types: DotNetTypes, schemas?: OpenAPI3Schemas): IDotnetType;
