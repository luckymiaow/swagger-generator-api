...
function getFileId(basePath, output, fileName, defaultPath) {
    let fileId = '';
    if (typeof output === 'function') {
        ...
        else if ((0, node_path_1.isAbsolute)(output))
            fileId = node_path_1.default.join(output, `${fileName}`);
        else
            fileId = node_path_1.default.join(basePath, output, `${fileName}`);
    }
